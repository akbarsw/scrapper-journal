    ...
    <>
       ...
       <aside className="w-[240px] border-r border-gray-200 bg-[#FAFAFA] flex flex-col h-full shrink-0 fixed md:static z-50">
        <div className="p-4 flex items-center justify-between">
          <div className="w-[26px] h-[26px] rounded bg-teal-600 flex items-center justify-center text-white font-serif font-bold text-sm leading-none">N</div>
          <button onClick={() => setSidebarOpen(false)} className="p-1 hover:bg-gray-200 rounded md:hidden cursor-pointer">
          ...
          <button onClick={() => setSidebarOpen(false)} className="p-1 hover:bg-gray-200 rounded hidden md:block cursor-pointer">
        ...
        <div className="px-3 py-2 space-y-1 flex-1">
          <button 
             ...
             className="w-full flex items-center gap-3 px-3 py-2 text-[14px] font-semibold text-gray-900 rounded-lg hover:bg-gray-200 transition-colors cursor-pointer"
          >
          ...
          <button 
             ...
             className={`w-full flex items-center gap-3 px-3 py-2 text-[14px] rounded-lg transition-colors mt-2 cursor-pointer ${activeTab === 'search' ? 'bg-gray-200 text-gray-900 font-semibold' : 'text-gray-600 hover:bg-gray-100'}`}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> Home
          </button>
          
          <button 
             onClick={() => setActiveTab('library')}
             className={`w-full flex items-center gap-3 px-3 py-2 text-[14px] rounded-lg transition-colors cursor-pointer ${activeTab === 'library' ? 'bg-gray-200 text-gray-900 font-semibold' : 'text-gray-600 hover:bg-gray-100'}`}
          >
          ...
          <button 
             ...
             className={`w-full flex items-center gap-3 px-3 py-2 text-[14px] rounded-lg transition-colors cursor-pointer ${activeTab === 'history' ? 'bg-gray-200 text-gray-900 font-semibold' : 'text-gray-600 hover:bg-gray-100'}`}
          >
          ...
          <button 
             onClick={() => setActiveTab('search')}
             className={`w-full flex items-center gap-3 px-3 py-2 text-[14px] font-semibold rounded-lg transition-colors cursor-pointer ${activeTab === 'search' ? 'bg-teal-50 text-teal-700' : 'text-gray-600 hover:bg-gray-100'}`}
          >
